...
ignition::math::v4::Vector3d GazeboWindPlugin::TrilinearInterpolation(ignition::math::v4::Vector3d link_position, ignition::math::v4::Vector3d *values, double* points) const {
